...
import 'package:fast_delivery/widgets/entryComponent_widget.dart';
import 'package:fast_delivery/widgets/iconButton_widget.dart';
        ...
        child: Padding(
          ...
          child: ListView(
            children: [
              ...
              const SizedBox(
                width: double.infinity,
                child: DescriptionText_widget(description: "Lorem ipsum dolor sit amet", align: TextAlign.left),
              ),
              const SizedBox(
                height: 56,
              ),
              ...
              Row(
                children: [
                  Container(margin: const EdgeInsets.only(top: 0.0), child: const DescriptionText_widget(description: "Forgot password?")),
                  TextButton(
